...
gopher_min<-matrix(data=c(0, 2.40*0.357, 5.35*0.25, 0.5, 0, 0, 0, 0.357, 0.25),  
                   nrow=3, ncol=3, byrow=TRUE,
                   dimnames=list(stages,stages))
gopher_min


gopher_avg<-matrix(data=c(0, 2.53*0.468, 7.78*0.449, 0.5, 0, 0, 0, 0.468, 0.449),  
                   nrow=3, ncol=3, byrow=TRUE,
                   dimnames=list(stages,stages))
gopher_avg

gopher_max<-matrix(data=c(0, 2.67*0.570, 10.2*0.67, 0.5, 0, 0, 0, 0.570, 0.67),  
                    nrow=3, ncol=3, byrow=TRUE,
                    dimnames=list(stages,stages))
gopher_max
...
for(i in 1:length(n.init.df)){
  ...
  #print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Gopher/09.28Figs/color/K=175")
}
...
for(i in 1:length(n.init.df)){
  ...
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Gopher/09.28Figs/BW/K=175")
}
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  #print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Gopher/09.28Figs/color/K=100")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Gopher/09.28Figs/BW/K=100")
}
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  #print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Gopher/0928Figs/color/K=50")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Gopher/0928Figs/BW/K=50")
}
#looking at percent change
#percent_plot(sim=n.init.sim, r)
```
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  #print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Gopher/0928Figs/color/K=25")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Gopher/0928Figs/BW/K=25")
}
