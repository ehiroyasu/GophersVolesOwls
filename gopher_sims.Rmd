...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  #print(plots)
  #ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="../Figures/Gopher/color/1005Figs/K=50")
}
...
ggsave("K=50 Plots.pdf", all_plots_bw, device="pdf", path="F:/GopherProject/GophersVolesOwls/Figures/Gopher/BW/116Figures")
...
ggsave("K=25 Plots.pdf", all_plots_bw, device="pdf", path="F:/GopherProject/GophersVolesOwls/Figures/Gopher/BW/116Figures")
```
...
```{r, echo=FALSE}
gopher.table<-gopher.table[,c("N.init", "N", "P", "r", "K")]
#Saving the table with all of the tabulated final results.
write.csv(gopher.table, "F:/GopherProject/GophersVolesOwls/GopherTable.csv", row.names=FALSE)
```
