...
for(i in 1:length(n.init.df)){
  ...
  print(plots)
  #ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", #path="F:/GopherProject/GophersVolesOwls/Figures/Gopher/adjustedY/K=175")
}
...
for(i in 1:length(n.init.df)){
  ...
  #ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Gopher/BW/adjustedY/K=175")
}
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  #print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Gopher/adjustedY/K=100")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Gopher/BW/adjustedY/K=100")
}
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  #print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Gopher/adjustedY/K=50")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Gopher/BW/adjustedY/K=50")
}
#looking at percent change
#percent_plot(sim=n.init.sim, r)
```
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  #print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Gopher/adjustedY/K=25")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Gopher/BW/adjustedY/K=25")
}
