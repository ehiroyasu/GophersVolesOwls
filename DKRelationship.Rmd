...
P_splitN1<-split(eq[[1]], P)
P_splitN2<-split(eq[[2]], P)

plot_eq(P_splitN1[[2]], P_splitN2[[2]], P, i=2)

#plotting in a loop still not working
for(i in 1:length(P_splitN1)){
  plot_eq(P_splitN1[[i]], P_splitN2[[i]], P, i=i)
}

N2P_split<-split(N2, P)
lapply(N2P_split, plot_eq)
