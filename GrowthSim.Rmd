...
plot(sample1976[[1]]$P[-1], sample1976[[1]]$diff[-1], ylim=c(-0.10, 0.02), type='l', main="Predator abundance vs Percent change in prey", xlab="Predator abundance (individuals/ha)", ylab="Percent change in prey density")
...
plot(sample1977[[1]]$P[-1], sample1977[[1]]$diff[-1], ylim=c(-0.10, 0.02), type='l', main="Predator abundance vs Percent change in prey", xlab="Predator abundance (individuals/ha)", ylab="Percent change in prey density")
...
plot(sample1978[[1]]$P[-1], sample1978[[1]]$diff[-1], ylim=c(-0.10, 0.02), type='l', main="Predator abundance vs Percent change in prey", xlab="Predator abundance (individuals/ha)", ylab="Percent change in prey density")
