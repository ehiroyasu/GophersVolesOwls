...
plot(r1976_t20$.id, r1976_t20$N, xlab="r value", ylab="Population Density (individuals/ha)", ylim=c(0,175), main="1976 r value versus population at time 20")
lines(r1976_t20$.id, r1976_t20$P, col=5)
...
plot(r1977_t20$.id, r1977_t20$N, xlab="r value", ylab="Population Density (individuals/ha)", ylim=c(0,175), main="1977 r value versus population at time 20")
lines(r1977_t20$.id, r1977_t20$P, col=5)
legend("topleft", legend=c("Prey", "Predator"), col=c(1,5), lty=c(1,1))

r1978<-ldply(r1978_sim, data.frame)
r1978_t20<-subset(r1978, time==20, select=c(.id, N, P))
plot(r1978_t20$.id, r1978_t20$N, xlab="r value", ylab="Population Density (individuals/ha)", ylim=c(0,175), main="1978 r value versus population at time 20")
lines(r1978_t20$.id, r1978_t20$P, col=5)
legend("topleft", legend=c("Prey", "Predator"), col=c(1,5), lty=c(1,1))
