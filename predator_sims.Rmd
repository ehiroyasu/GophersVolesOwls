...
plot(P, percent.diff1976[1, 2:6], ylim=c(-120,20), type='l', col=1, ylab="Percent Change in Prey", xlab="Predator Density per Ha", main="Percent change in Prey by Predator Density")
...
plot(P, sample1976[1, 2:6], type='l', col=1, ylim=range(min(sample1976[,2:6]), max(sample1976[,2:6])), ylab="Percent Change in Prey", xlab="Predator Density per Ha", main="Percent change in Prey by Predator Density", lwd=2)
