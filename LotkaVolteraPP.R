...
parameters <- c(r = log(3.47), alpha = 0.3, beta = 0.5, delta = 0.5, K_prey = 175, k_max=10, D=1/(0.3*5))#, K_pred = 6)
state<-c(N = 10, P = 6)
...
plot(out[,2], xlab = "time", ylab = "gopher density", type='l') #plots on separate graphs
abline(h=6, col=3)
