...
vole_min<-matrix(data=c(0, 3.45*0.023, 0.20, 0.023),  
                   nrow=2, ncol=2, byrow=TRUE,
                   dimnames=list(stages,stages))
vole_min


vole_avg<-matrix(data=c(0, 5.02*0.35, 0.28, 0.35),
                   nrow=2, ncol=2, byrow=TRUE,
                   dimnames=list(stages,stages))
vole_avg

vole_max<-matrix(data=c(0, 6.56*0.51, 0.41, 0.51),  
                    nrow=2, ncol=2, byrow=TRUE,
                    dimnames=list(stages,stages))
vole_max
...
for(i in 1:length(n.init.df)){
  ...
  print(plots)
  #ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/adjustedY/K=1000")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  print(plots_bw)
  #ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/BW/adjustedY/K=1000")
}
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  #print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/adjustedY/K=500")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/BW/adjustedY/K=500")
}
```
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  #print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/adjustedY/K=100")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/BW/adjustedY/K=100")
}
```
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  #print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/adjustedY/K=50")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/BW/adjustedY/K=50")
}
