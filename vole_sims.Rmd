...
for(i in 1:length(n.init.df)){
  ...
  print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Vole/K=1000")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Vole/BW/K=1000")
}
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Vole/K=500")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Vole/BW/K=500")
}
```
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Vole/K=100")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Vole/BW/K=100")
}
```
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Vole/K=50")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="D:/GopherProject/GophersVolesOwls/Figures/Vole/BW/K=50")
}
