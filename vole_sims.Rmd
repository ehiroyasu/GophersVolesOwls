...
for(i in 1:length(n.init.df)){
  ...
  #ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/color/1005Figs/K=1000")
}
...
for(i in 1:length(n.init.df)){
  ...
  #print(plots_bw)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/BW/1005Figs/K=1000")
}
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  #print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/color/0928Figs/K=500")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/BW/0928Figs/K=500")
}
```
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  #print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/color/0928Figs/K=100")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/BW/0928Figs/K=100")
}
```
...
for(i in 1:length(n.init.df)){
  plots<-(plot_n(n.init.df[[i]], r, N, K_prey, i))
  #print(plots)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/color/0928Figs/K=50")
}

for(i in 1:length(n.init.df)){
  plots_bw<-plot_n_bw(n.init.df[[i]], r, N, K_prey, i)
  ggsave(paste("N=", unique(N)[i], ", K=", K_prey, ".png"), plots_bw, device="png", path="F:/GopherProject/GophersVolesOwls/Figures/Vole/BW/0928Figs/K=50")
}
