...
k_max = maximum feeding rate the most gophers an owl can eat in a single time unit(1/handling time) (voles/season). Calculated from empirical data.
...
for(i in 1:length(n.init.df)){
   plot_n_grid(df=n.init.df[[i]], r=r, N=N, K_prey=K_prey, i=i)
}
```
