#'Type III Lotka Volterra Predator Prey Function
#'
...
#'delta (death rate of the predator), K_prey (carrying capacity of the prey population), k_max (max feeding rate of the predator), 
#'q (foraging intensity), and D (half saturation constant)
#'
#'
